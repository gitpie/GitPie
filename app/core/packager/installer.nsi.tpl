...
# Set side image
!define MUI_HEADERIMAGE_BITMAP "<%= appPath %>\resources\app\resources\images\gitpie-wizard-image.bmp"
!define MUI_WELCOMEFINISHPAGE_BITMAP "<%= appPath %>\resources\app\resources\images\gitpie-wizard-image.bmp"
